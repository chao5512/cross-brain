...
public class DataSetMiningController {
     ...
     */
    @RequestMapping(value = "dataSetName")
    public ApiResult getDataSetName(@RequestParam("userName") String userName){
        ...
        return ResultUtil.success(dataSetNameList);
    }

    /**
     * 功能描述:根据数据集名查询表字段信息
     * @param userName,dataSetName
     * @return: com.dataset.management.common.ApiResult
     * @auther: 王培文
     * @date: 2018/6/21 15:23
     */
    @RequestMapping("dataSetColumns")
    public ApiResult getDataSetColumns(@RequestParam("userName") String userName,@RequestParam("dataSetName") String dataSetName){
